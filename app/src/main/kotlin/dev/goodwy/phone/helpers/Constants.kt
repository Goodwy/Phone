...
private const val PATH = "dev.goodwy.phone.action."
...
// Dialpad button style
const val DIALPAD_BUTTONS_STYLE_DEFAULT = 0
const val DIALPAD_BUTTONS_STYLE_COLOR = 1
const val DIALPAD_BUTTONS_STYLE_TRANSPARENT = 2
