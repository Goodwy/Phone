...
import dev.goodwy.phone.databinding.ItemContactWithNumberGridSwipeBinding
import dev.goodwy.phone.databinding.ItemContactWithNumberInfoSwipeBinding
...
//            }
//        }
        // Fix: NullPointerException: Missing required view with ID: dev.goodwy.phone:id/item_contact_holder
        if (!activity.isDestroyed && !activity.isFinishing) {
