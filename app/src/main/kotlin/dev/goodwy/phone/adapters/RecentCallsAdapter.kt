...
import dev.goodwy.phone.activities.CallHistoryActivity
import dev.goodwy.phone.activities.MainActivity
import dev.goodwy.phone.activities.SimpleActivity
import dev.goodwy.phone.databinding.ItemRecentCallBinding
import dev.goodwy.phone.databinding.ItemRecentCallSwipeBinding
import dev.goodwy.phone.databinding.ItemRecentsDateBinding
import dev.goodwy.phone.extensions.areMultipleSIMsAvailable
import dev.goodwy.phone.extensions.callContactWithSim
import dev.goodwy.phone.extensions.callContactWithSimWithConfirmationCheck
import dev.goodwy.phone.extensions.config
import dev.goodwy.phone.extensions.getCountryByNumber
import dev.goodwy.phone.extensions.getDayCode
import dev.goodwy.phone.extensions.launchSendSMSIntentRecommendation
import dev.goodwy.phone.extensions.setWidth
import dev.goodwy.phone.extensions.startAddContactIntent
import dev.goodwy.phone.extensions.startCallWithConfirmationCheck
import dev.goodwy.phone.extensions.startContactDetailsIntentRecommendation
import dev.goodwy.phone.helpers.CURRENT_RECENT_CALL
import dev.goodwy.phone.helpers.CURRENT_RECENT_CALL_LIST
import dev.goodwy.phone.helpers.RecentsHelper
import dev.goodwy.phone.helpers.SWIPE_ACTION_BLOCK
import dev.goodwy.phone.helpers.SWIPE_ACTION_DELETE
import dev.goodwy.phone.helpers.SWIPE_ACTION_MESSAGE
import dev.goodwy.phone.helpers.SWIPE_ACTION_NONE
