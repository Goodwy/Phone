...
import dev.goodwy.phone.databinding.ActivitySettingsBinding
import dev.goodwy.phone.dialogs.ChangeTextDialog
import dev.goodwy.phone.dialogs.ExportCallHistoryDialog
import dev.goodwy.phone.dialogs.ManageVisibleTabsDialog
    ...
    private fun setupDialPadOpen() {
        binding.apply {
            ...
            settingsOpenDialpadAtLaunchHolder.setOnClickListener {
                ...
                binding.settingsDefaultTabHolder.beVisibleIf(!config.openDialPadAtLaunch)
            }
        }
    }
