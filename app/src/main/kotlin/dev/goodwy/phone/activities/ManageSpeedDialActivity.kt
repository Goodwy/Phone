...
import dev.goodwy.phone.adapters.SpeedDialAdapter
import dev.goodwy.phone.databinding.ActivityManageSpeedDialBinding
import dev.goodwy.phone.dialogs.AddSpeedDialDialog
import dev.goodwy.phone.dialogs.SelectContactDialog
import dev.goodwy.phone.dialogs.SelectSIMDialog
import dev.goodwy.phone.extensions.areMultipleSIMsAvailable
import dev.goodwy.phone.extensions.config
import dev.goodwy.phone.extensions.getAvailableSIMCardLabels
import dev.goodwy.phone.extensions.getHandleToUse
import dev.goodwy.phone.interfaces.RemoveSpeedDialListener
...
class ManageSpeedDialActivity : SimpleActivity(), RemoveSpeedDialListener {
    ...
    private fun showHideVoicemailIcon(id: Int, isVoicemail: Boolean) {
        if (id == 1) {
            if (isVoicemail && !config.hideDialpadLetters) {
